...
// Termina Field Buisness Scrub in hideout 150 rupees or 100 rupees Heart Piece text
    ...
    EZTR_Basic_AddCustomText(
        ...
        EZTR_NO_VALUE,
        false,
        "You found the " EZTR_CC_COLOR_RED "Deku Stick Bag" EZTR_CC_COLOR_DEFAULT "!" EZTR_CC_NEWLINE 
        "You can now hold " EZTR_CC_COLOR_RED "10 Deku Sticks" EZTR_CC_COLOR_DEFAULT "!" EZTR_CC_END,
        NULL
    );
    EZTR_Basic_AddCustomText(
